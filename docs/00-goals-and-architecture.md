...
demonstrated. The strict answer value schema is implemented; candidate tooling, evidence-policy
enforcement, and clinical evaluation remain subsequent work.
